...
const MainTreeAppEditor = () => {
  ...
  return (
    <>
      <SEO title="Quản lý ứng dụng ngành hàng" description="Quản lý ứng dụng" url="/main-trees" />
...
export default MainTreeAppEditor;